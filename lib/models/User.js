...
const { convertCharLvlToCasterLvl } = require('../utils/spell-utils');
...
module.exports = class User {
  ...
  static async updateUserInfo(id, newAttributes) {
    //* calls our helper function to calculate the user caster level based on their submitted character level
