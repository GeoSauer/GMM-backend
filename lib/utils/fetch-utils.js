...
//* update() Step 4: takes in an array of indices and maps through it, hitting the API endpoint for each spell and returning a custom object for each with just the values necessary for later retrieval
